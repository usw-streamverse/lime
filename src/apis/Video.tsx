...
const Video = () => {
  ...
  const history = () => {
    return JwtInterceptor().instance.get<VideoItem[]>('/record');
  }
  ...
  return { upload, list, popularList, history, subscriptionList, watch, update, like, writeComment, getComment, deleteComment, getReply, likeComment, addPlayList };
}
